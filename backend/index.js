...
app.get('/patient/profile', verifyToken, verifyUserTable, requireRole('paitent'), (req, res) => {
    res.json({ message: 'Patient-only profile route', user: req.user });
});

app.get('/doctor/profile', verifyToken, verifyUserTable, requireRole('doctor'), (req, res) => {
